...
{
   public class StageBaseSelector : Composite
   {
       public SharedInt CurrentStage;
       public List<string> IncludedTaskPerStage;
        ...
        public override void OnStart()
        {
            ...
            childIndexList = IncludedTaskPerStage[CurrentStage.Value].Split(',').Select(int.Parse).ToList();
